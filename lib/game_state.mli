...
val advance_turn : ?effect:Card.Value.t -> t -> t
val apply_declared_color : t -> Card.t -> Card.Color.t option -> (t, Error.t) result
val apply_draw_penalty : t -> direction:Direction.t -> card:Card.t -> (t, Error.t) result
val find_player : t -> int -> (Player.t, Error.t) result
val check_valid_play : t -> Card.t -> (unit, Error.t) result
